...
import logging
import re
# Import from typing for generics (used for optional fields).
from typing import TypeVar, Optional
# Pydantic class for defining data models.
...
# get root logger
# logger is set to the root logger with the current module name for logging.
